# -*- coding: utf-8 -*-
# Generated by Django 1.10 on 2017-02-20 22:12
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('machines', models.ManyToManyField(to='data.Machine')),
            ],
        ),
        migrations.AddField(
            model_name='ram',
        ...
        migrations.AddField(
            ...
            name='disk',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='data.PhysicalDisk'),
        ),
        migrations.AddField(
            model_name='location',
            name='computers',
